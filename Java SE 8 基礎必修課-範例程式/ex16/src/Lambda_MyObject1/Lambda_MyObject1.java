...
public class Lambda_MyObject1 {
	public static void main(String[] args){
		...
		//使用Arrays的sort()方法進行由小到大排序stu物件陣列
		//排序規則為StudentComparator介面物件
		Arrays.sort(stu, new StudentComparator());

		System.out.println("  姓名  國文  英文  數學  總分  名次");
		System.out.println("============================");
		//以倒印方式印出stu物件陣列資訊，以及學生名次
